...
namespace ModuleDefinitions {
    ...
    public:
        PoolingModule(uint64_t x = 1, uint64_t y = 1, uint64_t z = 1, uint64_t strideX = 1, uint64_t strideY = 1, uint64_t strideZ = 1, uint64_t norm = 1, uint64_t type = 0) {
            this->m_id = 6;
        ...
        void replaceModule(uint64_t x = 1, uint64_t y = 1, uint64_t z = 1, uint64_t strideX = 1, uint64_t strideY = 1, uint64_t strideZ = 1, uint64_t norm = 1, uint64_t type = 0) {
